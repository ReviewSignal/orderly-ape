    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resources_cpu', models.CharField(default='1', max_length=16, verbose_name='Per-worker CPU')),
                ('resources_memory', models.CharField(default='2G', max_length=16, verbose_name='Per-worker memory')),
                ...
                ('job_deadline', models.CharField(default='1h', help_text='This should take into test fetching docker images, synctonization time, and actual test run time.', max_length=16, verbose_name='Job deadline')),
            ],
            options={
