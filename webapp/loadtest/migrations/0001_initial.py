    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_repo', models.CharField(default='github.com/ReviewSignal/k6-WordPress-benchmarks', max_length=200, verbose_name='Git repository')),
                ('source_ref', models.CharField(default='main', max_length=200, verbose_name='Git Reference')),
                ('source_script', models.CharField(default='loadtest.js', max_length=200, verbose_name='Test script file')),
                ('start_test_at', models.DateTimeField(blank=True, editable=False, null=True, verbose_name='Start test at')),
                ('resources_cpu', models.CharField(default='1', max_length=16, verbose_name='Per-worker CPU resources')),
                ('resources_memory', models.CharField(default='2G', max_length=16, verbose_name='Per-worker memory resources')),
                ('dedicated_nodes', models.BooleanField(default=True, verbose_name='Run each worker on a separate node')),
                ('node_selector', models.CharField(blank=True, help_text="Kubernetes node selector to use for worker pods (eg. 'cloud.google.com/gke-nodepool=default-pool')", max_length=200, verbose_name='Node selector')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', django_fsm.FSMField(choices=[('pending', 'Pending'), ('queued', 'Queued'), ('ready', 'Ready'), ('running', 'Running'), ('completed', 'Completed'), ('failed', 'Failed')], default='pending', max_length=50)),
